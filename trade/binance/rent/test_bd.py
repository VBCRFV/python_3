...
if __name__ == '__main__':
    ...
    ####################################################
    ### Создание переменных ###
    const = {'BTC': {'b': 'Antminer S9', 'c': 6, 'l': 1.35},
             'ETH': {'b': 'GPU', 'c': 50, 'l': 0.9},
             'LTC': {'b': 'Antminer L3', 'c': 150, 'l': 1.5}}
    txt_a = ""              # Дата
